...
const isNotActiveStyle = 'flex items-center p-[20px] text-gray-500 hover:text-black transition-all duration-300 ease-in-out capitalize';
const isActiveStyle = 'flex items-center p-[20px] bg-rbga-black font-extrabold border-r-2 border-spotify-green  transition-all duration-300 ease-in-out capitalize';
